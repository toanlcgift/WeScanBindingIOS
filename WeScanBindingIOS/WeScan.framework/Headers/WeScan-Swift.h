...
SWIFT_CLASS("_TtC6WeScan18HomeViewController")
...
@interface HomeViewController (SWIFT_EXTENSION(WeScan)) <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
